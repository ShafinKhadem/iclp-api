...
COPY public.invitations (exam_id, challenger_id, challengee_id, topic_id, status, result_id, challenge_id) FROM stdin;
\.
...
UXMopNL6-GagWUy8NuW7_ObNpEUorDjA	{"cookie":{"originalMaxAge":2591999996,"expires":"2021-07-21T16:03:00.154Z","httpOnly":true,"path":"/"},"passport":{"user":3}}	2021-07-21 22:03:01
eXKEJtrFHmlfj69FAToqVMrBnJTMiR6u	{"cookie":{"originalMaxAge":2591999999,"expires":"2021-07-21T16:31:21.950Z","httpOnly":true,"path":"/"},"passport":{"user":1}}	2021-07-21 22:31:22
...
1	tomriddle@hogwarts.edu	$2b$10$6Xtxh8BfMaj4F/xyRL6dZeyq9VPgQF14rVnbktQyWgLT38AT3WetW	voldemort	admin	f	$2b$10$6Xtxh8BfMaj4F/xyRL6dZe	t	2021-06-21 17:36:07.530494+06
3	1605047@ugrad.cse.buet.ac.bd	$2b$10$lu7MUJqdV6qlzhNY9vu5jOp17Cnr3FIM8V0XD6eFVHVAasz9Tri8W	ahsanul ameen	\N	f	$2b$10$lu7MUJqdV6qlzhNY9vu5jO	t	2021-06-21 17:36:20.577255+06
\.
...
SELECT pg_catalog.setval('public.challenge_results_id_seq', 29, true);
...
--
-- Name: invitations result_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.invitations
    ADD CONSTRAINT result_id FOREIGN KEY (result_id) REFERENCES public.challenge_results(id);
