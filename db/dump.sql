...
4	code	conditionals	{"tests": [], "statement": "Sorry, only C++ is available right now. This problem gives 5 marks for any text file with size less than 100KB."}	easy	5	\N
1	code	Multiplication	{"tests": [{"input": "3", "output": "15\\n"}, {"input": "5", "output": "25\\n"}], "statement": "you will be given an integer n (n can be either 3 or 5) as input. output n*5."}	hard	20	\N
...
3	code	Arrays	{"tests": [], "statement": "Sorry, only C++ is available right now. This problem gives 10 marks for any text file with size less than 100KB."}	medium	10	120
...
7	code	dummy_1	{"tests": [{"input": "3", "output": "15\\n"}, {"input": "5", "output": "25\\n"}], "statement": "you will be given an integer n (n can be either 3 or 5) as input. output n*5."}	easy	5	\N
8	code	dummy_2	{"tests": [{"input": "3", "output": "15\\n"}, {"input": "5", "output": "25\\n"}], "statement": "you will be given an integer n (n can be either 3 or 5) as input. output n*5."}	medium	10	\N
